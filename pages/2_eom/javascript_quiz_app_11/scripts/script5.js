...
const anwserArr = [['является местом установки устройств, предназначенных для работы с большим напряжением и выполняющие функции коммутации и защиты.'],['предназначен для установки аппаратуры линий 0,4 кВ и отвечает за распределение электроэнергии по потребителям'],['отвечает за преобразование напряжения от высокого к низкому.']] //Ответы в правильном порядке
const text = ["Отсек ввода высокого напряжения", "Шкаф низкого напряжения", "Отсек трансформатора"]
