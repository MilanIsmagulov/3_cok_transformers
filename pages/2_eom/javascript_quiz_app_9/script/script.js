...
const correctAnswers = [
    ['к кабельным присоединениям разрядников',  'к кабельным присоединениям силового трансформатора'],  // Правильные ответы для первой колонки
    ['трансформатор напряжения','предохранитель', 'вакуумный выключатель']   // Правильные ответы для второй колонки
];
...
nameOfCol.innerHTML = 'Верхняя дверь камеры КСО'
let nameOfCol2 = document.createElement('span')
nameOfCol2.classList.add('spancol', 'secondcol')
nameOfCol2.innerHTML = 'Нижняя дверь камеры КСО'
